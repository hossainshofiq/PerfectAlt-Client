        ...
        <div>
            <div style={{ backgroundImage: "url('https://cdn.pixabay.com/photo/2016/09/22/10/44/banner-1686943_1280.jpg')" }} className="relative w-full h-64 flex items-center justify-center text-center text-white bg-cover bg-center">
                ...
                <div className="flex flex-col gap-2">
                    <h1 className="relative text-2xl md:text-3xl lg:text-4xl font-bold">About PerfectAlt</h1>
            ...
            <div className="w-10/12 mx-auto my-12 p-6 bg-white shadow-lg rounded-lg border">
                <h2 className="text-2xl md:text-3xl font-semibold text-gray-800 mb-4">What is PerfectAlt?</h2>
                ...
                <h2 className="text-2xl md:text-3xl font-semibold text-gray-800 mt-6 mb-4">Why Choose PerfectAlt?</h2>
                ...
                <h2 className="text-2xl md:text-3xl font-semibold text-gray-800 mt-6 mb-4">How It Works?</h2>
                <p className="text-gray-700 leading-relaxed">
                ...
                <h2 className="text-2xl md:text-3xl font-semibold text-gray-800 mt-6 mb-4">Join Us Today!</h2>
                <p className="text-gray-700 leading-relaxed">
